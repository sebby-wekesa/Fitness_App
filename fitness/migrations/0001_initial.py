    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('workout_plan', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='fitness.workoutplan')),
            ],
        ),
        migrations.CreateModel(
            name='Set',
            fields=[
                ...
                ('workout_session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sets', to='fitness.workoutsession')),
            ],
            options={
                'ordering': ['order'],
            },
